...
class SAT:
    ...
    def __init__(self, cnf_file):
        ...
        self.assign_variables_to_ID(cnf_file)
        


    # assign each variable to an ID and store in dictionary
    def assign_variables_to_ID(self, cnf_file):
        i = 1
